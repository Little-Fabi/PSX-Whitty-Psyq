	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_LoFight, "BACK ALLEY BLITZ", {"LO FIGHT", "OVERHEAD", "BALLISTIC", NULL}},
				{"2", StageId_Underground, "JUST LIKE OLD TIMES", {"UNDERGROUND", NULL, NULL, NULL}},
				{"3", StageId_LoFightHQ, "BACK ALLEY BLITZ HQ", {"LO FIGHT HQ", "OVERHEAD HQ", "BALLISTIC HQ", "BALLISTIC BETA MIX"}},
				{"4", StageId_UndergroundHQ, "JUST LIKE OLD TIMES HQ", {"UNDERGROUND HQ", "UNDERGROUND IN GAME MIX", NULL, NULL}}
			};
		...
		case MenuPage_Credits:
		{
			static const struct
			{
				...
				{true, false, NULL, 0xFFFFFFFF, "WHITTY TEAM", ""},
				{false, false, NULL, 0xFF99d8ff, "Sock.clip", "Creator of Whitty, Main Artist and Animator"},
				{false, false, NULL, 0xFF67008c, "Nate Animate", "Project lead, Chart Cleanup, Secondary Artist,\nmade Hungry"},
				{false, false, NULL, 0xFF33ff70, "bbPanzu", "Main Coder, charted Underground\nand another fun song :)"},
				{false, false, NULL, 0xFF4cba6d, "KadeDev", "Original Vs Whitty Coder"},
				{false, false, NULL, 0xFF0091ff, "juliaa", "Main Charter"},
				{false, false, NULL, 0xFFffa32b, "The Only Volume", "Secondary Charter, Charted Ballistic"},
				{false, false, NULL, 0xFFffd82b, "El Senor Beast", "Secondary coder"},
				{false, false, NULL, 0xFF004f4f, "tictacto", "Created the trailer theme"},
				{false, false, NULL, 0xFF664012, "8-Bit", "Main Playtester"},
			};
